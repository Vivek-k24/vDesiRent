...
public final class HeaderLayoutBinding implements ViewBinding {
  ...
  private HeaderLayoutBinding(@NonNull RelativeLayout rootView, @NonNull LinearLayout header,
      @NonNull TextView headerText, @NonNull ImageView searchIcon) {
  ...
  public static HeaderLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HeaderLayoutBinding((RelativeLayout) rootView, header, headerText, searchIcon);
    }
